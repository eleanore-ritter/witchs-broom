...
bedtools intersect \
-a jitterbug_merlot_wt/merlotwt.jitterbug.TE_insertions_paired_clusters.filtered.gff3 \
-b jitterbug_merlot_wb/merlotwb.jitterbug.TE_insertions_paired_clusters.filtered.gff3 \
-v \
-nonamecheck \
> merlotwt_unique_merlot_TEs.gff3
...
