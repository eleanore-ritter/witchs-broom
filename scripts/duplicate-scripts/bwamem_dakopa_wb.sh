...
ID=$(zcat Dakopa_Witch_s_Broom_S4_L002_R1_001.cutadapt.fq.gz | head -1 | cut -d ':' -f 3,4 | tr ':' '.')
PU=$(zcat Dakopa_Witch_s_Broom_S4_L002_R1_001.cutadapt.fq.gz | head -1 | cut -d ':' -f 3,4,10 | tr ':' '.')
SM="DakopaWB"
PL="ILLUMINA"
LB="lib1"
...
Vvinifera.fa \
Dakopa_Witch_s_Broom_S4_L002_R1_001.cutadapt.fq.gz Dakopa_Witch_s_Broom_S4_L002_R2_001.cutadapt.fq.gz > Dakopa_WB_bwamem.sam
....
