...
ID=$(zcat Dakopa_Wild_Type_S3_L002_R1_001.cutadapt.fq.gz | head -1 | cut -d ':' -f 3,4 | tr ':' '.')
PU=$(zcat Dakopa_Wild_Type_S3_L002_R1_001.cutadapt.fq.gz | head -1 | cut -d ':' -f 3,4,10 | tr ':' '.')
SM="DakopaWT"
PL="ILLUMINA"
LB="lib1"
