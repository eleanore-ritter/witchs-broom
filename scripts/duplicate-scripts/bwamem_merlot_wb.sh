...
ID=$(zcat Merlot_Witch_s_Broom_S2_L002_R1_001.cutadapt.fq.gz | head -1 | cut -d ':' -f 3,4 | tr ':' '.')
PU=$(zcat Merlot_Witch_s_Broom_S2_L002_R1_001.cutadapt.fq.gz | head -1 | cut -d ':' -f 3,4,10 | tr ':' '.')
SM="MerlotWB"
PL="ILLUMINA"
LB="lib1"
...
Vvinifera.fa \
Merlot_Witch_s_Broom_S2_L002_R1_001.cutadapt.fq.gz Merlot_Witch_s_Broom_S2_L002_R2_001.cutadapt.fq.gz > Merlot_WB_bwamem_1.sam
....
