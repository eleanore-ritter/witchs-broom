...
ID=$(zcat Merlot_Wild_Type_S1_L002_R1_001.cutadapt.fq.gz | head -1 | cut -d ':' -f 3,4 | tr ':' '.')
PU=$(zcat Merlot_Wild_Type_S1_L002_R1_001.cutadapt.fq.gz | head -1 | cut -d ':' -f 3,4,10 | tr ':' '.')
SM="MerlotWT"
PL="ILLUMINA"
LB="lib1"
...
Vvinifera.fa \
Merlot_Wild_Type_S1_L002_R1_001.cutadapt.fq.gz Merlot_Wild_Type_S1_L002_R2_001.cutadapt.fq.gz > Merlot_WT_bwamem_1.sam
....
