...
bedtools getfasta -fi $HOME/grape_project/new_grape_assembly/genome/Vvinifera.fa \
-bed $HOME/grape_project/scripts/grape_TE_closest_genes.bed \
-fo grape_TE_closest_genes.fa -name 
...
