...
bedtools intersect \
-a jitterbug_dakopa_wt/dakopawt.jitterbug.TE_insertions_paired_clusters.filtered.gff3 \
-b jitterbug_dakopa_wt/dakopawb.jitterbug.TE_insertions_paired_clusters.filtered.gff3 \
-nonamecheck \
-v \
> dakopa_bedtools_different_TEs.gff3
...
