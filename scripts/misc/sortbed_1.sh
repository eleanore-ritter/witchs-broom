...
#SBATCH --job-name bedtools_sort      # you can give your job a name for easier identification (same as -J)
#SBATCH --output=%x_%j.SLURMout

#change to working directory
cd $PBS_O_WORKDIR

bedtools sort -i $HOME/grape_project/new_grape_assembly/annotations/genes.gff 
