...
#SBATCH --job-name validatesamfile               # you can give your job a name for easier identification (same as -J)
#SBATCH --output=%x_%j.SLURMout

java -jar /mnt/home/rittere5/programs/picard.jar ValidateSamFile \
