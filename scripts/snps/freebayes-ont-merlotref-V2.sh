...
../../merlotwt/minimap2_merlotref_haplotigs_pbsv_merlotwt/aln-sorted-rg.bam

samtools addreplacerg \
-r "@RG\tID:merlotwbont\tLB:$LB\tPL:$PL\tSM:merlotwbont\tPU:$PU" \
-o merlotwb-rg-ont.bam \
../../merlotwb/minimap2_merlotref_haplotigs_pbsv_merlotwb/aln-sorted-rg.bam
...
-r VITVvi_vMerlFPS15_v1.1_Haplotig0007F_001:1-1356141 \
-g 1000 \
merlotwt-rg-ont.bam \
merlotwb-rg-ont.bam \
> Merlot_merlotref_freebayes_snps_ont_raw_haplotig7.vcf
