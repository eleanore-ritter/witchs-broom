...
cat dakapo-pn-smoove.genotyped.vcf | java -Xmx19G -jar /mnt/home/rittere5/programs/snpeff/snpEff/SnpSift.jar \
filter "(isVariant(GEN[0]) & isRef(GEN[1]))|(isHom(GEN[0]) & isHet(GEN[1]))|(isHet(GEN[0]) & isHom(GEN[1])" > dakapo-pn-filtered.vcf
...
